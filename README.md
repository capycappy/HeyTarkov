...
| | サイズ | 必要なもの |
|---|---|---|
| `HeyTarkov-v1.3.0-win-x64.zip` | 42MB | **なし**（これを選べばよい） |
| `HeyTarkov-v1.3.0-win-x64-framework-dependent.zip` | 0.6MB | .NET 10 Desktop Runtime |
...
初回だけは話す言語と Wiki も OS に合わせる。英語環境なら英語を聞き取り、英語 Wiki を開く。
2回目以降は保存された設定が優先される。
